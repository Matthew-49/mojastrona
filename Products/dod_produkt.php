...
function utworz($p_nazwa, $p_rozmiar, $p_producent, $p_dostepnosc, $p_cena, 
$p_typ, $p_opis){
...
$query= "INSERT INTO produkt (p_ID, p_nazwa, p_rozmiar, p_producent, p_dostepnosc, p_cena, 
p_typ, p_opis) 
VALUES (NULL, '$p_nazwa', '$p_rozmiar', '$p_producent', '$p_dostepnosc', '$p_cena', 
'$p_typ', '$p_opis')";
...
<li class="nav-link text-white text-right ">
    ...
    <main role="main" class="container">
            ...
            <div>
                ...
                $val = utworz($p_nazwa, $p_rozmiar, $p_producent, $p_dostepnosc, $p_cena, 
                $p_typ, $p_opis);
                if($val == OK){
