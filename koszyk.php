<!doctype html>
    ...
    <head>
        ...
        <title>TGT- Taktyczne Gry Terenowe</title>
    </head>
    ...
    <h2>Koszyk</h2>
			...
			<table>
				<tr>
					<td> Pełny koszt: </td>	            <td> <span id="totalCost"> </span>   </td>
				</tr>
				<tr>				
					<td> Koszt zawierający VAT: </td>	<td>    <span id="totalVAT"> </span>    </td>
				</tr>
			</table>
				
            <button class="btn btn-lg btn-primary btn-sm" type="button">Płatność</button>
